...
(function($) {
	...
	$.fn.numpad.defaults = {
		...
		displayTpl: '<input type="text" class="form-control  input-lg" />',
		displayCellTpl: '<td colspan="4"></td>',
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
		buttonNumberTpl: '<button type="button" class="btn btn-default btn-lg"></button>',
		buttonFunctionTpl: '<button type="button" class="btn btn-lg" style="width: 100%;"></button>',
		gridTableClass: '',
