...
(function($) {
	...
	$.fn.numpad.defaults = {
		...
		gridTpl: '<table class="modal-content table-responsive"></table>',
		displayTpl: '<input type="text" class="form-control input-lg" style="width:92%;margin:20px"/>',
		displayCellTpl: '<td colspan="4"></td>',
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
		buttonNumberTpl: '<button type="button" class="btn btn-default btn-lg" style="width: 90%;margin:0 0 20px 20px;"></button>',
		buttonFunctionTpl: '<button type="button" class="btn btn-lg" style="width: 80%;margin:0 0 20px 20px;"></button>',
		gridTableClass: '',
